...
// (rank-1)-length shape.
fn decode_idx(i : u32, base : u32, rank8 : u32, out_idx : ptr<function, array<u32, 8>>) {
  var rem = i;
...
fn a_strides_from_shape(base : u32, rank : u32, a_shape : ptr<function, array<u32, 8>>,
                        out_strides : ptr<function, array<u32, 8>>) {
  var acc : u32 = 1u;
